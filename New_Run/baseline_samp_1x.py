...
**python baseline_samp_1x.py ../../Data/LT/train_matrix_fd_man_aws.p LT/train/train ../../Data/LT/trgTrain.txt ../../Data/LT/srcTrain.txt


**python baseline_samp_1x.py ../../Data/LT/train_matrix_fd_aws_man.p LT/dev/dev /home/avadehra/scribendi/dataAudio/parsed/LIB_TED/dev_trg.txt /home/avadehra/scribendi/dataAudio/parsed/LIB_TED/dev_src0.txt
'''
...
def best_substitution(candidates):
	"""
			...
			for j in range(len(iPart)):
				...
				if not p_str in fdM:
					...
					if (len(p_cands) == 1):
						...
						p_edit = best_substitution(candidates = p_cand_vals)
